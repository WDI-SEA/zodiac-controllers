...
app.get('/water', (req, res) => {
  res.render('./water/index.ejs', {
    ...
    traits: ['Private', 'Mysterious', 'Pyschic', 'Charming', 'Emo', 'Sensitive']
  })
})
...
app.get('/earth', (req, res) => {
  res.render('./earth/index.ejs', {
    ...
    traits: ['Grounded', 'Helpful', 'Practical', 'Realistic', 'Dependable', 'Materialistic']
  })
})
...
app.get('/air', (req, res) => {
  res.render('./air/index.ejs', {
    ...
    traits: ['Movement', 'Creativity', 'Action', 'Lucky', 'Adventure', 'Easily Provoked']
  })
})
